...
| List tasks (bounded, one source)                   | `asana-cli tasks list --my-section=@alias\|--section=<gid>\|--project=<gid> [--assignee=me\|<gid>] [--completed=true\|false] --max=<n> [--all] --json`                                                                                          |
